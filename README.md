...
1. **Clone the repository**
   ```bash
   git clone https://github.com/A-P-S-Bhaidav/Make-Cuts-Game.git
   cd Make-Cuts-Game
   ```
...
- **Accessibility**: Keyboard navigation for edges, screen reader labels, reduced motion support
- **Performance**: CSS animations on compositor-friendly properties (opacity, transform), efficient BFS traversal
- **Code Organization**: Feature-based component folders, separated concerns (logic/hooks/components/styles)
- **SEO**: Meta descriptions, Open Graph tags, descriptive page titles
- **Responsive Design**: Mobile-first approach with CSS breakpoints at 480px, 640px, 768px, 900px

---

## License

This project is developed as part of a task submission. All rights reserved.
